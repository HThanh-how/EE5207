...
\begin{itemize}
    ...
    \item \texttt{pipelined.sv}: Final five-stage pipelined RV32I core used in Milestone~3.
\end{itemize}
...
For the pipelined implementation, the memory system is upgraded to synchronous 64~KiB models as required in Milestone~3:
\begin{itemize}
    \item \texttt{imem\_sync.sv}: 64~KiB synchronous instruction memory preloaded from \texttt{isa.mem}.
    \item \texttt{dmem\_sync.sv}: 64~KiB synchronous data memory and I/O interface.
\end{itemize}
